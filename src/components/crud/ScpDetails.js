...
function Detail() {
    ...
    return (
        <Box>
            ...
            <Paper elevation={3} sx={{ p: 3, m: 3, position: 'relative' }}>
                    ...
                    sx={{
                        ...
                        top: 0,
                        right: 0,
                        zIndex: 1, // To ensure the buttons appear above the Paper
                        display: 'flex',
                    }}
                >
                    <Tooltip title="Edit">
            ...
            <div>
                <Typography variant='h5' sx={{ mt: 2, mb: 1 }}>Addendum Text:</Typography>
        ...
        {scpDetails.HistoryText && (
            <div>
                <Typography variant='h5' sx={{ mt: 2, mb: 1 }}>History Text:</Typography>
        ...
        {scpDetails.NotesText && (
            <div>
                <Typography variant='h5' sx={{ mt: 2, mb: 1 }}>Notes Text:</Typography>
        ...
        {scpDetails.ReferencesText && (
            <div>
                <Typography variant='h5' sx={{ mt: 2, mb: 1 }}>References Text:</Typography>
